                        ...
                        <div class="">
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    <h1 class="font-semibold text-xl mb-1 block dark:text-slate-100">Data Fakultas
                                            ...
                                            @foreach ($fakultas as $item)
                                                <tr
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="{{ $item->link_fakultas_ut }}" target="_blank"
                                                            class="underline hover:text-blue-600">{{ $item->link_fakultas_ut }}</a>
                                                    </td>
                                                    <td
                                                        class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{ $item->alias }}</td>
                                                    <td
                                                        ...
                                                        <div class="flex items-center gap-2">
                                                            <form id="form-delete-{{ $item->id_fakultas }}"
                                                                action="{{ route('fakultas.destroy', $item->id_fakultas) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="button"
                                                                    onclick="handleDismiss('{{ $item->id_fakultas }}')">
                                                                    <i
