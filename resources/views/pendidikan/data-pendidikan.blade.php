                                ...
                                <div class="">
                                    <div class="flex flex-wrap justify-between">
                                        <div class="items-center ">
                                            <h1 class="font-semibold text-xl mb-1 block dark:text-slate-100">Data Pendidikan Universtias Terbuka Rokan Hilir</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="bg-white border-b border-dashed dark:bg-gray-800 dark:border-gray-700">
                                                        ...
                                                        <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                            {{ $pendidikan->program_pendidikan }}
                                                        </td>
                                                        <td class="p-3 text-lg text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                            <div class="flex items-center gap-2">
                                                                <a href="{{ route('pendidikan.edit', $pendidikan->id_pendidikan) }}">
                                                                    <i class="ti ti-edit text-lg text-yellow-500 dark:text-yellow-400"></i>
                                                                </a>
                                                                <form id="form-delete-{{ $pendidikan->id_pendidikan }}" action="{{ route('pendidikan.destroy', $pendidikan->id_pendidikan) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="button" onclick="handleDismiss('{{ $pendidikan->id_pendidikan }}')">
