                                ...
                                <div class="">
                                    <div class="flex flex-wrap justify-between">
                                        <div class="items-center ">
                                            <h1 class="font-semibold text-xl mb-1 block dark:text-slate-100">Data Agama Universtias Terbuka Rokan Hilir</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <tr class="bg-white border-b border-dashed dark:bg-gray-800 dark:border-gray-700">
                                                        ...
                                                        <td class="p-3 text-lg text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                            <div class="flex items-center gap-2">
                                                                <a href="{{ route('agama.edit', $agama->id_agama) }}">
                                                                    <i class="ti ti-edit text-lg text-yellow-500 dark:text-yellow-400"></i>
                                                                </a>
                                                                <form id="form-delete-{{ $agama->id_agama }}" action="{{ route('agama.destroy', $agama->id_agama) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="button" onclick="handleDismiss('{{ $agama->id_agama }}')">
