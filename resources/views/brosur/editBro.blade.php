...
<div class="ltr:flex flex-1 rtl:flex-row-reverse">
    <div class="page-wrapper relative ltr:ml-auto rtl:mr-auto rtl:ml-0 w-[calc(100%-276px)] px-4 pt-[54px] duration-300">
        ...
        <div class="xl:w-full  min-h-[calc(100vh-138px)] relative pb-14 ">
            <form action="{{ route('brosur.update', $data_brosur->id_brosur) }}" method="POST"
                    ...
                    <div id="form-container" class="formRem sm:col-span-6 md:col-span-6 lg:col-span-12 xl:col-span-12">
                        <div class="bg-white dark:bg-slate-800 shadow rounded-md w-full relative">
                            <div
                                ...
                                <h4 class="font-medium">Form Edit Data Brosur</h4>
                                ...
                                <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                    ...
                                    <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                        <div class="relative z-0 mb-2 w-full group">
                                            <label for="judul_brosur"
                                                class="font-medium text-sm text-slate-600 dark:text-slate-400">Judul
                                                Brosur</label>
                                            <input type="text" name="judul_brosur" id="judul_brosur"
                                                value="{{ old('judul_brosur', $data_brosur->judul_brosur) }}"
                                                class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1
                                        focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm
                                        hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                        {{ $errors->has('judul_brosur') ? 'border-red-500 is-invalid' : '' }}">
                                            @error('judul_brosur')
                                    ...
                                    <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                        <div class="relative z-0 mb-2 w-full group">
                                            <label for="kategori_brosur"
                                                class="font-medium text-sm text-slate-600 dark:text-slate-400">Kategori
                                                Brosur</label>
                                            <select name="kategori_brosur" id="kategori_brosur"
                                                class="form-select w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1
                                        focus:outline-none focus:ring-0 hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                        {{ $errors->has('kategori_brosur') ? 'border-red-500 is-invalid' : '' }}">
                                                <option value="Brosur"
                                                    {{ old('kategori_brosur', $data_brosur->kategori_brosur) == 'Brosur' ? 'selected' : '' }}>
                                                    Brosur</option>
                                                <option value="Poster"
                                                    {{ old('kategori_brosur', $data_brosur->kategori_brosur) == 'Poster' ? 'selected' : '' }}>
                                                    Poster</option>
                                            </select>
                                    ...
                                    <div class="sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12 ">
                                        ...
                                        focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm
                                        hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                        {{ $errors->has('brosur') ? 'border-red-500 is-invalid' : '' }}">
                                            @error('brosur')
                                                <div class="invalid-feedback text-red-500 font-medium text-sm">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            @if ($data_brosur->brosur)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/' . $data_brosur->brosur) }}"
                                                        alt="Preview" class="w-32 h-auto rounded shadow-md">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
