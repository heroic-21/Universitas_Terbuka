                        ...
                        <div class="">
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    <h1 class="font-semibold text-xl mb-1 block dark:text-slate-100">Data Agama
                                        Universtias Terbuka Rokan Hilir</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            @foreach ($brosur as $item)
                                                <tr
                                                    ...
                                                    <td
                                                        ...
                                                        {{ $loop->iteration }} <!-- ini increment 1,2,3,... -->
                                                    </td>
                                                    <td
                                                    ...
                                                    <td
                                                        ...
                                                        <div class="flex items-center gap-2">
                                                            <a href="{{ route('brosur.edit', $item->id_brosur) }}">
                                                                <i
                                                                    class="ti ti-edit text-lg text-yellow-500 dark:text-yellow-400"></i>
                                                            </a>
                                                            <form id="form-delete-{{ $item->id_brosur }}"
                                                                action="{{ route('brosur.destroy', $item->id_brosur) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="button"
                                                                    onclick="handleDismiss('{{ $item->id_brosur }}')">
                                                                    <i
