...
<div class="ltr:flex flex-1 rtl:flex-row-reverse">
    <div class="page-wrapper relative ltr:ml-auto rtl:mr-auto rtl:ml-0 w-[calc(100%-276px)] px-4 pt-[54px] duration-300">
        ...
        <div class="xl:w-full  min-h-[calc(100vh-138px)] relative pb-14 ">
            @if ($errors->has('nim'))
                <div id="error-bar"
                    class="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded transition-opacity duration-500">
                    {{ $errors->first('nim') }}
                </div>
                <script>
                    setTimeout(() => {
                                    ...
                                    <div class="flex-auto p-4">
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <input type="text" name="nama_lengkap[]"
                                                        id={{ 'oldnama_lengkap_' . $i }}
                                                        value="{{ old('nama_lengkap.' . $i) }}"
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <input type="text" name="tempat_lahir[]"
                                                        id={{ 'oldtempat_lahir_' . $i }}
                                                        value="{{ old('tempat_lahir.' . $i) }}"
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-1 mb-2 w-full group">
                                                    ...
                                                    <input type="text" name="tanggal_lahir[]"
                                                        id={{ 'Old_Default_Datepicker_' . $i }}
                                                        value="{{ old('tanggal_lahir.' . $i) }}"
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                        ...
                                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                            <div class="sm:col-span-4 md:col-span-4 lg:col-span-4 xl:col-span-4 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <input type="email" name="email[]" id={{ 'oldemail_' . $i }}
                                                        value="{{ old('email.' . $i) }}"
                                            ...
                                            <div class="sm:col-span-4 md:col-span-4 lg:col-span-4 xl:col-span-4 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <input type="text" name="default_password[]"
                                                        id={{ 'olddefault_password_' . $i }}
                                                        value="{{ old('default_password.' . $i) }}"
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <input type="text" name="nama_ibu_kandung[]"
                                                        id={{ 'oldnama_ibu_kandung_' . $i }}
                                                        value="{{ old('nama_ibu_kandung.' . $i) }}"
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                        ...
                                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <input type="text" name="tahun_masuk[]"
                                                        id={{ 'oldtahun_masuk_' . $i }}
                                                        value="{{ old('tahun_masuk.' . $i) }}"
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <label for={{ 'oldtahun_wisuda_' . $i }}
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Tahun
                                                    Wisuda</label>
                                                <input type="text" name="tahun_wisuda[]"
                                                    id={{ 'oldtahun_wisuda_' . $i }}
                                                    value="{{ old('tahun_wisuda.' . $i) }}"
                                                    class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                        ...
                                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                            ...
                                            {{ $errors->has('keterangan.' . $i) ? 'border-red-500 is-invalid' : '' }}">
                                                        ...
                                                        <option value="Aktif"
                                                            {{ old("keterangan.$i") == 'Aktif' ? 'selected' : '' }}>
                                                            Aktif</option>
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    <select name="status_pekerjaan[]"
                                                        id={{ 'oldstatus_pekerjaan_' . $i }}
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            {{ $errors->has('status_pekerjaan.' . $i) ? 'border-red-500 is-invalid' : '' }}">
                                                        <option value="">-- Pilih Status Pekerjaan --</option>
                                                        <option value="Bekerja"
                                                            {{ old("status_pekerjaan.$i") == 'Bekerja' ? 'selected' : '' }}>
                                                            Bekerja</option>
                                                        <option value="Tidak Bekerja"
                                                            {{ old("status_pekerjaan.$i") == 'Tidak Bekerja' ? 'selected' : '' }}>
                                        ...
                                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    <label for={{ 'oldjenis_kelamin_' . $i }}
                                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Jenis
                                                        Kelamin</label>
                                                    <select name="jenis_kelamin[]" id={{ 'oldjenis_kelamin_' . $i }}
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            {{ $errors->has('jenis_kelamin.' . $i) ? 'border-red-500 is-invalid' : '' }}">
                                                        <option value="">-- Pilih Jenis kelamin --</option>
                                                        <option value="P"
                                                            {{ old("jenis_kelamin.$i") == 'P' ? 'selected' : '' }}>
                                                            Perempuan</option>
                                                        <option value="L"
                                                            {{ old("jenis_kelamin.$i") == 'L' ? 'selected' : '' }}>
                                                            Laki-laki</option>
                                                    </select>
                                                    @error("jenis_kelamin.$i")
                                                        <div class="invalid-feedback text-red-500 font-medium text-sm">
                                                            {{ $message }}
                                                        </div>
                                                    @enderror
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    <label for={{ 'oldstatus_pernikahan_' . $i }}
                                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Status
                                                        Pernikahan</label>
                                                    <select name="status_pernikahan[]"
                                                        id={{ 'oldstatus_pernikahan_' . $i }}
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            {{ $errors->has('status_pernikahan.' . $i) ? 'border-red-500 is-invalid' : '' }}">
                                                        <option value="">-- Pilih Status Pernikahan --</option>
                                                        <option value="Belum Menikah"
                                                            {{ old("status_pernikahan.$i") == 'Belum Menikah' ? 'selected' : '' }}>
                                                            Belum Menikah</option>
                                                        <option value="Menikah"
                                                            {{ old("status_pernikahan.$i") == 'Menikah' ? 'selected' : '' }}>
                                                            Menikah</option>
                                                        <option value="Duda/Janda"
                                                            {{ old("status_pernikahan.$i") == 'Duda/Janda' ? 'selected' : '' }}>
                                                            Duda/Janda</option>
                                                    </select>
                                                    @error("jenis_kelamin.$i")
                                                        <div class="invalid-feedback text-red-500 font-medium text-sm">
                                        ...
                                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    <label for={{ 'oldlayanan_program_' . $i }}
                                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Jenis
                                                        Kelamin</label>
                                                    <select name="layanan_program[]" id={{ 'oldlayanan_program_' . $i }}
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            {{ $errors->has('layanan_program.' . $i) ? 'border-red-500 is-invalid' : '' }}">
                                                        <option value="">-- Pilih Layanan Program --</option>
                                                        <option value="SIPAS"
                                                            {{ old("layanan_program.$i") == 'SIPAS' ? 'selected' : '' }}>
                                                            SIPAS</option>
                                                        <option value="Non SIPAS"
                                                            {{ old("layanan_program.$i") == 'Non SIPAS' ? 'selected' : '' }}>
                                                            Non SIPAS</option>
                                                    </select>
                                                    @error("layanan_program.$i")
                                                        <div class="invalid-feedback text-red-500 font-medium text-sm">
                                                            {{ $message }}
                                                        </div>
                                                    @enderror
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    <label for={{ 'oldjalur_program_' . $i }}
                                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Status
                                                        Pernikahan</label>
                                                    <select name="jalur_program[]"
                                                        id={{ 'oldjalur_program_' . $i }}
                                                        class="form-input w-full rounded-md mt-1 border dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700
                                            {{ $errors->has('jalur_program.' . $i) ? 'border-red-500 is-invalid' : '' }}">
                                                        <option value="">-- Pilih Status Pernikahan --</option>
                                                        <option value="Non RPL"
                                                            {{ old("jalur_program.$i") == 'Non RPL' ? 'selected' : '' }}>
                                                            Non RPL - SMA/SMK/MA/Paket-C/Muaddallah
                                                        Setara MA/SMA Terbuka</option>
                                                        <option value="RPL"
                                                            {{ old("jalur_program.$i") == 'RPL' ? 'selected' : '' }}>
                                                            RPL/Alih Kredit - (Melanjutkan diri
                                                        D3/Linierisasi S-1/Pindah Kuliah Ke UT)</option>
                                                    </select>
                                                    @error("jalur_program.$i")
                                                        <div class="invalid-feedback text-red-500 font-medium text-sm">
                                                            {{ $message }}
                                                        </div>
                                                    @enderror
                                        ...
                                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    <label for="{{ 'oldkode_program_studi_' . $i }}"
                                                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Prodi</label>
                                                    <select name="kode_program_studi[]"
                                                        id="{{ 'oldkode_program_studi_' . $i }}"
                                                    ...
                                                    border
                                                    {{ $errors->has('kode_program_studi.' . $i) ? 'border-red-500 dark:border-red-500 is-invalid' : 'border-slate-300/60 dark:border-slate-700' }}">
                                                        <option value=""
                                                            {{ old("kode_program_studi.$i") == '' ? 'selected' : '' }}>
                                                            -- Pilih Prodi --</option>
                                                        @foreach ($prodi as $prodis)
                                                            <option class="dark:bg-slate-800"
                                                                value="{{ $prodis->kode_program_studi }}"
                                                                {{ old("kode_program_studi.$i") == $prodis->kode_program_studi ? 'selected' : '' }}>
                                                                {{ $prodis->fakultas->alias }} - {{ $prodis->program_studi }} ({{ $prodis->pendidikan->program_pendidikan }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error("kode_program_studi.$i")
                                                        <div
                                                            class="invalid-feedback text-red-500 font-medium text-sm mt-1">
                                                            {{ $message }}
                                                        </div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                                <div class="relative z-0 mb-2 w-full group">
                                                    ...
                                                    {{ $errors->has('id_agama.' . $i) ? 'border-red-500 dark:border-red-500 is-invalid' : 'border-slate-300/60 dark:border-slate-700' }}">
                                                        <option value=""
                                                            {{ old("id_agama.$i") == '' ? 'selected' : '' }}>-- Pilih
                                                            Agama --</option>
                                                        @foreach ($agama as $agamas)
                                                            <option class="dark:bg-slate-800"
                                                                value="{{ $agamas->id_agama }}"
                            ...
                            <div class="bg-white dark:bg-slate-800 shadow rounded-md w-full relative">
                                ...
                                <div class="flex-auto p-4">
                                        ...
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="nama_lengkap___index__"
                                                    ...
                                                    Lengkap</label>
                                                <input type="text" name="nama_lengkap[]"
                                                    id="nama_lengkap___index__" disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="tempat_lahir___index__"
                                                    ...
                                                    Lahir</label>
                                                <input type="text" name="tempat_lahir[]"
                                                    id="tempat_lahir___index__" disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
                                            </div>
                                        </div>
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                                        ...
                                        <div class="sm:col-span-4 md:col-span-4 lg:col-span-4 xl:col-span-4 ">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="default_password___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Password</label>
                                                <input type="text" name="default_password[]"
                                                    id="default_password___index__" disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
                                            </div>
                                        </div>
                                        <div class="sm:col-span-4 md:col-span-4 lg:col-span-4 xl:col-span-4 ">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="nomor_hp___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Nomor
                                                    Handphone</label>
                                                <input type="text" name="nomor_hp[]" id="nomor_hp___index__"
                                                    disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="status_pekerjaan___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Status
                                                    Pekerjaan</label>
                                                <select name="status_pekerjaan[]" id="status_pekerjaan___index__"
                                                    disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700">
                                                    <option value="">-- Pilih Status Pekerjaan --</option>
                                    ...
                                    <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="jenis_kelamin___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Jenis
                                                    Kelamin</label>
                                                <select name="jenis_kelamin[]" id="jenis_kelamin___index__" disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700">
                                                    <option value="">-- Pilih Jenis Kelamin --</option>
                                        ...
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="status_pernikahan___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Status
                                                    Pernikahan</label>
                                                <select name="status_pernikahan[]" id="status_pernikahan___index__"
                                                    disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700">
                                                    <option value="">-- Pilih Status Pernikahan --</option>
                                    ...
                                    <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="layanan_program___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Layanan
                                                    Program</label>
                                                <select name="layanan_program[]" id="layanan_program___index__"
                                                    disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700">
                                                    <option value="">-- Pilih Layanan Program --</option>
                                        ...
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="jalur_program___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Jalur
                                                    Program</label>
                                                <select name="jalur_program[]" id="jalur_program___index__" disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700">
                                                    <option value="">-- Pilih Jalur Program --</option>
                                                    <option value="Non RPL">Non RPL - SMA/SMK/MA/Paket-C/Muaddallah
                                                        Setara MA/SMA Terbuka</option>
                                                    <option value="RPL">RPL/Alih Kredit - (Melanjutkan diri
                                                        D3/Linierisasi S-1/Pindah Kuliah Ke UT)</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                        <div class="sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-6">
                                            <div class="relative z-0 mb-2 w-full group">
                                                <label for="kode_program_studi___index__"
                                                    class="font-medium text-sm text-slate-600 dark:text-slate-400">Prodi</label>
                                                <select name="kode_program_studi[]" id="kode_program_studi___index__"
                                                    disabled
                                                    class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700">
                                                    ...
                                                    @foreach ($prodi as $prodis)
                                                        <option class="dark:bg-slate-800"
                                                            value="{{ $prodis->kode_program_studi }}">
                                                            {{ $prodis->fakultas->alias }} -
                                                            {{ $prodis->program_studi }}
                                                            ({{ $prodis->pendidikan->program_pendidikan }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
