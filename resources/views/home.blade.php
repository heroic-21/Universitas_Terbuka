...
<body class="home-14">
    ...
    <div class="banner-14 banner-area bg-relative banner-area-1 bg-cover bg-center bi-26">
        ...
        <img class="animate-img-1 animate-topImageBounce" src="{{ asset('assets/landing/images/banner/2.png') }}"
            alt="img">
        ...
        <div class="container">
            <div class="row">
                <div class="custom-md:w-1/2">
                    <div class="about-thumb-inner custom-lg:pe-[48px] custom-lg:me-[48px]" data-aos="fade-up"
                        data-aos-duration="800" data-aos-delay="300">
                        <img class="animate-img-1 animate-topImageBounce"
                            src="{{ asset('assets/landing/images/about/2.png') }}" alt="img">
                        <img class="animate-img-2 animate-leftImageBounce"
                            src="{{ asset('assets/landing/images/about/3.png') }}" alt="img">
                        <img class="animate-img-3 animate-topImageBounce"
                            src="{{ asset('assets/landing/images/banner/5.svg') }}" alt="img">
                        <img class="animate-img-3 ac-5 animate-topImageBounce"
                            src="{{ asset('assets/landing/images/about/34.png') }}" alt="img">
                        <img class="animate-img-3 ac-6 animate-topImageBounce"
                            src="{{ asset('assets/landing/images/about/35.png') }}" alt="img">
                            ...
                            <div class="custom-sm:w-1/2 custom-md:w-full custom-2xl:w-6/12">
                                <div class="single-about-inner">
                                    ...
                                    <div class="details font-bold">
                                        ...
                                        <p>Tutorial, bimbingan, dan fasilitas belajar yang mendukung kesuksesan studi
                                            Anda.
                                        </p>
                                    </div>
                                </div>
    ...
    <div class="service-area bg-relative pd-top-100">
        <img class="position-bottom-left animate-topImageBounce"
    ...
    <div class="pricing-area pd-top-100 pd-bottom-90">
        <div class="container">
            ...
            <div class="row">
                <div class="custom-md:w-1/2 custom-sm:w-1/2">
                    <div class="single-pricing-inner style-3 pa-o wow animate__animated animate__fadeInUp"
                        data-wow-duration="0.8s">
                ...
                <div class="custom-md:w-1/2 custom-sm:w-1/2">
                    <div class="single-pricing-inner style-3 pa-h wow animate__animated animate__fadeInUp"
        ...
        <div class="container">
            <div class="row pd-top-120">
                <div class="custom-lg:w-6/12 custom-md:w-1/2 custom-sm:w-8/12 order-lg-last hidden custom-md:block">
                    <div class="about-thumb-inner custom-md:pt-[16px] animate__animated" data-aos="fade-up"
                        data-aos-duration="800" data-aos-delay="300">
                        <img class="main-img pt-[10rem]" src="{{ asset('assets/landing/images/MHS3.png') }}"
                            alt="img">
                        <img class="an-img animate-topImageBounce"
                            src="{{ asset('assets/landing/images/Elemen1.png') }}" alt="img">
                        <img class="an-img-two animate-topImageBounce"
                            src="{{ asset('assets/landing/images/Elemen2.png') }}" alt="img">
                    </div>
                </div>
                <div class="custom-lg:w-6/12 custom-md:w-1/2 animate__animated" data-aos="fade-up"
                    ...
                    <div class="accordion accordion-inner style-2 accordion-icon-left" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    <p>Universitas Terbuka (UT) adalah Perguruan Tinggi Negeri (PTN) yang berdiri sejak
                                        tahun 1984, berpusat di Pondok Cabe, Tangerang Selatan, Banten. UT berada
                                        langsung di bawah naungan Kementerian Pendidikan, Kebudayaan, Riset, dan
                                        Teknologi (Kemendikbudristek). Sebagai kampus negeri penyelenggara pendidikan
                                        jarak jauh (PJJ) / online</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <p>Dengan sistem perkuliahan tersebut, Universitas Terbuka menghadirkan pendidikan
                                        tinggi yang fleksibel, terjangkau, dan terpercaya. Model ini sangat sesuai bagi
                                        lulusan baru, pekerja, pendidik, maupun masyarakat umum yang ingin melanjutkan
                                        pendidikan tanpa harus meninggalkan kesibukan sehari-hari.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Universitas Terbuka tidak menetapkan jadwal perkuliahan tetap seperti perguruan
                                        tinggi konvensional. Sistem pembelajaran di UT bersifat fleksibel, sehingga
                                        mahasiswa dapat mengatur sendiri waktu belajar sesuai dengan aktivitas dan
                                        kesibukan masing-masing.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Justru Universitas Terbuka memang dirancang khusus untuk masyarakat yang ingin
                                        melanjutkan pendidikan tinggi sambil tetap bekerja atau menjalankan aktivitas
                                        lain.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full custom-lg:w-11/12">
                    <div class="row tc-p">
                        <div class="w-full custom-xs:w-6/12 custom-md:w-1/3 custom-lg:w-3/12">
                            <div class="case__single wow animate__animated animate__fadeInUp"
                                data-wow-duration="0.8s">
                                <div class="thumb">
        ...
        <div class="container">
            <div class="contact-inner-1">
                <div class="row align-items-center tc-p">
                    <div class="custom-md:w-1/2 wow animate__animated animate__fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.3s">
                        <div class="contact-inner">
                            <h6 class="subtitle wow animate__animated animate__fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.3s">
                                SALUT Negeri Seribu Kubah</h6>
                            <h2 class="title wow animate__animated animate__fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.6s">Keunggulan
                                <span>Universitas Terbuka </span>
                            </h2>
                            <ul>
                                <li><i class="fa fa-check"></i>PTN dengan Akreditasi UNGGUL/A dari BAN-PT dan
                                    Internasional (AAOU, ICDE,ASIC)</li>
                                <li><i class="fa fa-check"></i>Banyak program beasiswa tersedia</li>
                                <li><i class="fa fa-check"></i>Tanpa batasan lulusan tahun ijazah
                                    (SMA/SMK/MA/MAK/PAKET-C/SMA-TERBUKA/MUADALAH-Setara MA/ dan SLTA sederajat)</li>
                                <li><i class="fa fa-check"></i>Tanpa tes masuk, KKN, Skripsi dan DO</li>
                                <li><i class="fa fa-check"></i>Sistem perkuliahan online & fleksibel, perangkat
                                    perkuliahan dapat mengunakan PC, Smartphone, laptop, iPad, Tablet</li>
                                <li><i class="fa fa-check"></i>Teknologi ITC Mutahir dan Canggih dengan berbagai
                                    platform Digital</li>
                                <li>
                                    <i class="fa fa-check"></i>
                                    Biaya terjangkau mulai dari Rp. 1,3 Jt/Smtr (SIPAS) dan Rp. 36 Ribu s/d Rp. 78 Ribu
            ...
            <div class="row">
                <div class="custom-md:w-1/2 custom-sm:w-1/2">
                    <div class="single-blog-list wow animate__animated animate__fadeInUp" data-wow-duration="0.8s">
                        <div class="thumb">
                            <img class="border-radius-5" src="{{ asset('assets/landing/images/blog/4.png') }}"
                                alt="img">
                        </div>
                        <div class="details">
                ...
                <div class="custom-md:w-1/2 custom-sm:w-1/2">
                    <div class="single-blog-list wow animate__animated animate__fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.3s">
                        <div class="thumb">
                            <img class="border-radius-5" src="{{ asset('assets/landing/images/blog/5.png') }}"
                                alt="img">
                        </div>
                        <div class="details">
                            <ul class="blog-meta p-0">
